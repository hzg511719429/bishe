...
<div class="content">
    <div style=" width:400px;margin:auto; border:1px solid #eee; overflow:auto; zoom:1;">
        <form id="regist" action="editPassword" name="regist" method="post">
            ...
            <dl>
                <dt> 密码</dt>
                <dd><input class="ipt" type="password" name="password" id="passWord"
                           onfocus="this.style.border='2px solid #f60';"
                           onblur="this.style.border='2px solid #F08300';"/>
                    <span style="color: red">${spassword}</span>
                    <div style="margin-top: 10px" class="tipinfo"></div>
                    <input class="ipt" type="hidden" name="userId" value="${userId}"/>
                </dd>
            </dl>
            <dl>
                <dt>确认密码</dt>
                <dd><input class="ipt" type="password" name="passwordAgain" id="passWordAgain"
                           onfocus="this.style.border='2px solid #f60';"
                           onblur="this.style.border='2px solid #F08300';"/>
                    <span style="color: red">${spassword2}</span>
                    <div style="margin-top: 10px" class="tipinfo"></div>
                </dd>
            </dl>
