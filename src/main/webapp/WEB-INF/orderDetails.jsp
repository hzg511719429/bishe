...
<head>
    <style type="text/css">
        ...
        .main-tab{position:absolute; width:104px; height:26px; line-height:26px; background:#a4bed4; left:35px; top: 0px; border:1px #000 solid; border-bottom:none;text-align:center; margin-top: 50px}
        .main-tab-ex{border-bottom:1px #000 solid; margin-top: 50px}
        ...
        .main-p{background:#a4bed4; height:30px; line-height: 30px;}
    ...
    <div class="main" >
        ...
        <div  class="main-tab-ex">
            <table>
                ...
                <tr class="main-tab-ex-tr1" height="40" style=" ">
                    <td   colspan="6">订单编号：${orderAndUser.orderNo}</td>
                </tr>
                <tr  class="main-tab-ex-tr2" height="50">
                    <td colspan="2">点餐人信息：<a href="updateUser">${orderAndUser.userName}</a><a style="padding-left:70px;">${orderAndUser.userPhone}</a></td>
                    <td >成交时间：</td>
